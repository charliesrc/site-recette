...
<body>
  ...
  $last_recette = "SELECT ID, Titre, Contenu, Photo, Type, Difficulte, Prix, Date_creation FROM Recette ORDER BY ID DESC LIMIT 0, 5";
  $result = mysqli_query($bdd, $last_recette);
